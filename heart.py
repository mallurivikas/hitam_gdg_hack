...
df = pd.read_csv("C:\\Users\\vikas\\OneDrive\\Desktop\\Projects\\GDG HACK\\dataset\\heart.csv")   # replace with your dataset

# 2️ Check the data
print(df.head())

# 3️ Define features and target
X = df.drop('target', axis=1)    # 'target' = 0 (no risk) / 1 (at risk)
y = df['target']
