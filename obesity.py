...
df = pd.read_csv("C:\\Users\\vikas\\OneDrive\\Desktop\\Projects\\GDG HACK\\dataset\\obesity.csv")   # replace with your dataset

# 2️ Check the data
print(df.head())

# 3️ Define features and target
X = df.drop('NObeyesdad', axis=1)  # Drop target column
...
print("\nClassification Report (Test Data):\n", classification_report(y_test, y_test_pred, target_names=df['NObeyesdad'].unique()))
